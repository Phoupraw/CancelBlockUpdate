...
final class English extends FabricLanguageProvider {
    ...
    public void generateTranslations(TranslationBuilder b) {
        ...
        b.add("modmenu.descriptionTranslation." + CancelBlockUpdate.MOD_ID, "Cancel block updates, block schedule ticks, random ticks, place validation, fluid schedule ticks. Keep this mod on during world generation will generate lots of floating blocks. Switch this mod by game rule " + CBUGameRules.OFF.getName() + ".");
        b.add(CBUGameRules.OFF.getTranslationKey(), modName + ": disable all effects of the mod");
        b.add(CBUGameRules.REPLACE.getTranslationKey(), modName + ": allow replace grass");
    }
